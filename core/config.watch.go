...
// 配置观察key对象回调, 如果是第一次触发, isFirst 为 true
type ConfigWatchKeyCallback func(isFirst bool, oldData, newData []byte)
...
// 配置观察key对象回调, 如果是第一次触发, isFirst 为 true
type ConfigWatchKeyStructCallback[T any] func(isFirst bool, oldData, newData T)
